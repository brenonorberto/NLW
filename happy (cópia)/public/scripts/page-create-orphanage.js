//create map
const map = L.map('mapid').setView([-3.7987653,-38.4994594], 15)
...
function addPhotoField() {
    ...
    // verificar se o campo está vazio, se sim, não adicioner ao container de imagens
...
function toggleSelect(event) {
    ...
    document.querySelector('.button-select button')
